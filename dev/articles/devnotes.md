...
| `rattler-build upload anaconda -o tidywf --api-key <xxx> ${HOME}/tmp/r-tidywigits.conda` | upload conda pkg to anaconda |
...
| `pkgdown::build_article("devnotes")` | builds devnotes vignette only |
