...
#>  [1] "sample1_germline_purple_drivercatalog.parquet"
#>  [2] "sample1_purple_cnvgenetsv.parquet"            
#>  [3] "sample1_purple_cnvsomtsv.parquet"             
#>  [4] "sample1_purple_drivercatalog.parquet"         
#>  [5] "sample1_purple_germdeltsv.parquet"            
#>  [6] "sample1_purple_purityrange.parquet"           
#>  [7] "sample1_purple_puritytsv.parquet"             
#>  [8] "sample1_purple_qc.parquet"                    
#>  [9] "sample1_purple_somclonality.parquet"          
#> [10] "sample1_purple_somhist.parquet"               
#> [11] "version_purple_version.parquet"               
```
