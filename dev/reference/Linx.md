...
#>  [1] "sample1_germline_linx_breakends.parquet"    
#>  [2] "sample1_germline_linx_clusters.parquet"     
#>  [3] "sample1_germline_linx_drivercatalog.parquet"
#>  [4] "sample1_germline_linx_links.parquet"        
#>  [5] "sample1_germline_linx_svs.parquet"          
#>  [6] "sample1_linx_breakends.parquet"             
#>  [7] "sample1_linx_clusters.parquet"              
#>  [8] "sample1_linx_drivercatalog.parquet"         
#>  [9] "sample1_linx_drivers.parquet"               
#> [10] "sample1_linx_fusions.parquet"               
#> [11] "sample1_linx_links.parquet"                 
#> [12] "sample1_linx_svs.parquet"                   
#> [13] "sample1_linx_viscn.parquet"                 
#> [14] "sample1_linx_visfusion.parquet"             
#> [15] "sample1_linx_visgeneexon.parquet"           
#> [16] "sample1_linx_visproteindomain.parquet"      
#> [17] "sample1_linx_vissegments.parquet"           
#> [18] "sample1_linx_vissvdata.parquet"             
#> [19] "version_2_linx_version.parquet"             
#> [20] "version_linx_version.parquet"               
```
