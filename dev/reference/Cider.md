...
#> [1] "sample1_2_cider_vdj.parquet"      "sample1_cider_alignmatch.parquet"
#> [3] "sample1_cider_blastn.parquet"     "sample1_cider_locusstats.parquet"
#> [5] "sample1_cider_vdj.parquet"       
```
